      ...
      </div>
      {
        loggedIn ?
          <div className='flex flex-col items-center justify-center space-x-8 lg:flex-row ml-4 lg:ml-10 xl:ml-20'>
            ...
            <div className='w-40'>
              <p className='hover:cursor-pointer border-2 border-green-100 bg-green-100 p-2 px-4 rounded-full text-sm font-bold font-body text-center overflow-ellipsis whitespace-nowrap overflow-hidden'><span className=''>{currentUser.isAnonymous ? "Anonymous" : currentUser.userName ? currentUser.userName : currentUser.email}</span></p>
            </div>
