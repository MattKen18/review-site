...
const AddImage = () =>  {
  ...
  // const displayNumImagesRemaining = uploadedImages.length < 3 ? `Review image uploads remaining: ${3 - uploadedImages.length}` : 'Maximum number of images per review'
  return (
    <>
      <div className='flex items-center justify-center space-x-2'>
        <h1 className='text-center text-3xl font-bold'>Add Images</h1><span className='text-sm font-normal'>(Optional)</span>
      </div>

      <div className='flex flex-col w-11/12 mt-20 m-auto bg-white rounded-md p-10 py-20'>
      {/* image container */}
      {/* <h1 className='text-center text-sm mb-4'>{displayNumImagesRemaining}</h1> */}
